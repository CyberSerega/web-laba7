...
{
    height: 150px;
    background: url("source/header-wrapper-bg.png");
...
Таким образом, я закрепил навыки работы с HTML и CSS на примере создания полноценного сайта с использованием указанных технологий. Все поставленные цели и задачи были выполнены.
